    ...
    <main className="lg:col-span-3 xl:col-span-5 bg-gray-100 p-8 h-[100vh] overflow-y-scroll">
      <section className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 mt-10 gap-8">
        <div className="bg-primary-100 p-8 rounded-xl text-gray-300 flex flex-col gap-6">
          ...
          <span className="py-1 px-3 bg-green-700 rounded-full">APROBADO</span>
        </div>
        <div className="p-4 bg-white rounded-xl flex flex-col justify-between gap-4 drop-shadow-2xl">
          ...
          <div className="bg-primary-100/10 rounded-xl p-4">
            ...
            <div className="flex items-center gap-2 text-gray-500 text-sm">
              <a
                href="https://platzi.com/cursos/backend/"
                target="_blank"
              ...
              <div className="group relative inline-block">
                ...
                <div className="absolute invisible group-hover:visible z-10 w-48 p-2 mt-2 text-sm text-white bg-primary-100 rounded-md shadow-lg left-1/2 transform -translate-x-1/2">
                  "Bienvenidos al curso de Backend. Aquí aprenderán a construir
                  la lógica interna de aplicaciones, gestionar bases de datos y
                  crear APIs que conecten el mundo digital. Nuestro enfoque será
                  práctico, claro y directo, para que puedan desarrollar
                  proyectos sólidos desde el primer día."
